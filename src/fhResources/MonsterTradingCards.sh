...
echo "Should return HTTP 200 - and a list of all cards"
echo .
curl -i -X PUT http://localhost:10001/deck --header "Content-Type: application/json" --header "Authorization: Bearer kienboec-mtcgToken" -d "[\"ed1dc1bc-f0aa-4a0c-8d43-1402189b33c8\", \"65ff5f23-1e70-4b79-b3bd-f6eb679dd3b5\", \"55ef46c4-016c-4168-bc43-6b9b1e86414f\", \"f3fad0f2-a1af-45df-b80d-2e48825773d9\"]"
echo "Should return HTTP 2xx"
echo .
curl -i -X GET http://localhost:10001/deck --header "Authorization: Bearer kienboec-mtcgToken"
echo "Should return HTTP 200 - and a list of all cards"
